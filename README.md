...
This sample project provided an opportunity to explore the different customers in a retailer's customer and order list. The data is from an actual UK based online retailer for transactions occurring between Jan 2010 and September 2011 and can be found in the UC Irvine Machine Learning Repository "Online Retail" (also called number 352).
